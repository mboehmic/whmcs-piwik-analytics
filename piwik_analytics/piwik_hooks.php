...
function piwik_analytics_hook_checkout_tracker($vars) {
	...
	$domain = getHost($referer);


	if ($domain == $modulevars['piwikSite1Hostname']) {
	...
	elseif ($domain == $modulevars['piwikSite6Hostname']) {
	...
	$code .= "the db value of piwikID " .$modulevars['piwikSite1ID'] ."</br>";
	$code .= "the db value of piwikSite1Hostname " .$modulevars['piwikSite1Hostname'] ."</br>";
	$code .= "the db value of piwikID " .$modulevars['piwikSite2ID'] ."</br>";
	$code .= "the db value of piwikSite1Hostname " .$modulevars['piwikSite2Hostname'] ."</br>";
	
	$code .= "the domain was ". $domain ."</br>";
